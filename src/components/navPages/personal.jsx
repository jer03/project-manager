...
function Personal() {
  ...
  const createNewNote = async () => {
    try {
      ...
      console.error('Error adding personal document: ', error);
    }
  };
  ...
  const deleteNote = async (noteId) => {
    try {
      const userId = auth.currentUser.uid;
      const noteRef = doc(firestore, 'users', userId, 'personalNotes', noteId);
  ...
  // Function to edit a personal note (set edit mode)
  ...
  // Function to save edited personal note
  ...
  // Function to mark a personal note as completed
  const markNoteAsCompleted = async (noteId) => {
    try {
      ...
      console.error('Error marking personal note as completed: ', error);
    }
  };
