  ...
  return (
    <Layout>
      <div className="rounded-lg flex flex-col">
        <h3 className="text-4xl font-bold mb-4 text-center mt-6">Personal Projects</h3>
                ...
                <button onClick={() => handleDeleteFile(url, index)} className="text-red-500 hover:text-red-700 transition-colors duration-300 ml-2">
                  <MdDeleteForever className="text-xl" />
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <button onClick={() => saveEditedNote(note.id, { title: note.title, description: note.description, dueDate: note.dueDate, files: note.files, tasks: note.tasks?.map(task => ({
